...
$argument->hasvalue('1');
is ($argument->toString(), ":sometag $valueNumeric" , 'toString multiline (TAGGED has value)');
# Technically an invalid combination...
$argument->hasvalue(0);
is ($argument->toString(), $valueNumeric , 'toString multiline (TAGGED has novalue)');
...
$argument = Parse::Sieve::Argument::Numeric->new(
		...
		hasvalue => 42 ) ;
$argument->value($value);
is ($argument->toString(), $valueNumeric , 'toString multiline (POSITIONAL has value)');
$argument->hasvalue(0);
is ($argument->toString(), $valueNumeric , 'toString multiline (POSITIONAL has novalue)');
...
$argument = Parse::Sieve::Argument::Numeric->new(
		...
		hasvalue => 42 ) ;
$argument->value($value);
is ($argument->toString(), ":sometag $valueNumeric" , 'toString multiline (OPTIONAL has value)');
# Technically an invalid combination...
$argument->hasvalue(0);
is ($argument->toString(), $valueNumeric , 'toString multiline (OPTIONAL has novalue)');
...
$argument->hasvalue('1');
is ($argument->toString(), ":sometag $valueNumeric" , 'toString singular (TAGGED has value)');
# Technically an invalid combination...
$argument->hasvalue(0);
is ($argument->toString(), $valueNumeric , 'toString singular (TAGGED has novalue)');
...
$argument = Parse::Sieve::Argument::Numeric->new(
		...
		hasvalue => 42 ) ;
$argument->value($value);
is ($argument->toString(), $valueNumeric , 'toString singular (POSITIONAL has value)');
$argument->hasvalue(0);
is ($argument->toString(), $valueNumeric , 'toString singular (POSITIONAL has novalue)');
...
$argument = Parse::Sieve::Argument::Numeric->new(
		...
		hasvalue => 42 ) ;
$argument->value($value);
is ($argument->toString(), ":sometag $valueNumeric" , 'toString singular (OPTIONAL has value)');
# Technically an invalid combination...
$argument->hasvalue(0);
is ($argument->toString(), $valueNumeric , 'toString singular (OPTIONAL has novalue)');
...
# Pop
my $tagged = Parse::Sieve::Argument::Numeric->new(
		type => 'tagged',
		tag => ':mytag',
		hasvalue => '0');
...
my $positional = Parse::Sieve::Argument::Numeric->new(
		type => 'positional',
		tag => '',
		hasvalue => '0');
...
$value = $positional->popvalue(\@tmp);
@tmp = grep {$_} @tmp;
is ($value, undef, 'Pop Positional String - value');
is ($positional->value, undef, 'Pop Positional String - return');
is_deeply (\@tmp, \@stringParams, 
				'Pop Positional Numeric - arguments');
...
my $optional = Parse::Sieve::Argument::Numeric->new(
		type => 'optional',
		tag => ':mytag',
		hasvalue => '0');
...
# Pop
$tagged = Parse::Sieve::Argument::Numeric->new(
		type => 'tagged',
		tag => ':mytag',
		hasvalue => '1');
...
$value = $tagged->popvalue(\@tmp);
@tmp = grep {$_} @tmp;
is ($value, undef , 'Pop Tag String (hasvalue) - return');
is ($tagged->value, undef , 'Pop Tag String (hasvalue) - value');
is_deeply (\@tmp, \@stringParams, 'Pop Tag String (hasvalue) - arguments');
...
$positional = Parse::Sieve::Argument::Numeric->new(
		type => 'positional',
		tag => '',
		hasvalue => '1');
...
$value = $positional->popvalue(\@tmp);
@tmp = grep {$_} @tmp;
is ($value, undef, 'Pop Positional String (hasvalue) - value');
is ($positional->value, undef, 'Pop Positional String (hasvalue) - return');
is_deeply (\@tmp, \@stringParams, 
...
$optional = Parse::Sieve::Argument::Numeric->new(
		type => 'optional',
		tag => ':mytag',
		hasvalue => '1');
...
$value = $optional->popvalue(\@tmp);
@tmp = grep {$_} @tmp;
is ($value, undef , 'Pop Optional String (hasvalue) - return');
is ($optional->value, undef , 'Pop Optional String (hasvalue) - value');
is_deeply (\@tmp, \@stringParams, 'Pop Optional String (hasvalue) - arguments');
